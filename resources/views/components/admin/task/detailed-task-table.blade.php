        ...
        <div class="px-4 mx-auto">
            <div class="min-w-full my-4 overflow-x-auto border rounded-md shadow-sm">
                <table class="min-w-full bg-white rounded whitespace-nowrap">
                    ...
                    <tr class="">
                        <th class="px-3 py-3 text-xs font-normal text-left text-gray-500 uppercase align-middle">Task ID</th>
                        <th class="px-3 py-3 text-xs font-normal text-left text-gray-500 uppercase align-middle">Title</th>
                        <th class="px-3 py-3 text-xs font-normal text-left text-gray-500 uppercase align-middle">Body</th>
                        <th class="px-3 py-3 text-xs font-normal text-right text-gray-500 uppercase align-middle">Comments</th>
                        <th class="px-3 py-3 text-xs font-normal text-left text-gray-500 uppercase align-middle">Category</th>
                        <th class="px-3 py-3 text-xs font-normal text-right text-gray-500 uppercase align-middle">Status</th>
                        <th class="px-3 py-3 text-xs font-normal text-right text-gray-500 uppercase align-middle">Created_at</th>
