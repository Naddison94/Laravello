                        ...
                        <div class="md:col-span-2 xl:col-span-1">
                            <div class="rounded bg-gray-200 dark:bg-gray-800 p-3">
                                ...
                                <div class="text-sm text-black dark:text-gray-50 mt-2">
                                    ...
                                    @if($tasks->pending->isNotEmpty() && $tasks->pending->count() > 8)
                                        <div class="w-full px-4 py-3 text-xs text-gray-500 border-t bg-gray-50">
                                            {{ $tasks->pending->links() }}
                                        </div>
                                    @endif
                        ...
                        <div class="md:col-span-2 xl:col-span-1">
                            <div class="rounded bg-gray-200 dark:bg-gray-800 p-3">
                                ...
                                <div class="text-sm text-black dark:text-gray-50 mt-2">
                                    ...
                                    @if($tasks->in_progress->isNotEmpty() && $tasks->in_progress->count() > 8)
                                        <div class="w-full px-4 py-3 text-xs text-gray-500 border-t bg-gray-50 sm:grid-cols-9">
